...
export default function HomePage() {
  ...
  const handleLanguageSelect = (language: Language) => {
    router.push(`/practice?lang=${language.slug}&langId=${language.id}`)
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Choose a language to start practicing coding exercises
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {languages.map((language) => (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${LANGUAGE_COLORS[language.slug] || 'from-gray-400 to-gray-600'} opacity-10 rounded-xl`}></div>
